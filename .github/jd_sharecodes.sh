...
for sharecode in ${PETSHARECODES_ARR[${IFS}]}
    do
        echo "PET: ${sharecode}"
...
for sharecode in ${FRUITSHARECODES_ARR[${IFS}]}
    do
...
for sharecode in ${PLANT_BEAN_SHARECODES_ARR[${IFS}]}
    do
...
for sharecode in ${DDFACTORY_SHARECODES_ARR[${IFS}]}
    do
...
for sharecode in ${JXFACTORY_SHARECODES_ARR[${IFS}]}
    do
