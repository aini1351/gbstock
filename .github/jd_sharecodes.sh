...
echo "PET: ${PETSHARECODES_ARR}"
echo "FRUIT: ${FRUITSHARECODES_ARR}"
echo "PLANT_BEAN: ${PLANT_BEAN_SHARECODES_ARR}"
echo "DDFACTORY: ${DDFACTORY_SHARECODES_ARR}"
echo "JXFACTORY: ${JXFACTORY_SHARECODES_ARR}"
